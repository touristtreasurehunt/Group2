...
@Component({
  selector: 'app-geolocation222',
  templateUrl: './geolocation222.page.html',
  styleUrls: ['./geolocation222.page.scss'],
})
export class Geolocation222Page implements OnInit {

  constructor(private router: Router) { }

  contentMap: any;
  position: any;
  coordinates = [28.1025208, -15.413272];
