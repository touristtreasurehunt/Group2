...
@Component({
  selector: 'app-geolocation123',
  templateUrl: './geolocation123.page.html',
  styleUrls: ['./geolocation123.page.scss'],
})
export class Geolocation123Page implements OnInit {

  constructor(private router: Router) { }

  contentMap: any;
  position: any;
  coordinates = [28.101960, -15.415738];
