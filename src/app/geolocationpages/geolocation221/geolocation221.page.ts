...
@Component({
  selector: 'app-geolocation221',
  templateUrl: './geolocation221.page.html',
  styleUrls: ['./geolocation221.page.scss'],
})
export class Geolocation221Page implements OnInit {

  constructor(private router: Router) { }

  contentMap: any;
  position: any;
  coordinates = [28.101718, -15.413821];
