...
@Component({
  selector: 'app-geolocation212',
  templateUrl: './geolocation212.page.html',
  styleUrls: ['./geolocation212.page.scss'],
})
export class Geolocation212Page implements OnInit {

  constructor(private router: Router) { }

  contentMap: any;
  position: any;
  coordinates = [28.101714, -15.413836];
