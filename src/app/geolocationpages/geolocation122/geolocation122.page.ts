...
@Component({
  selector: 'app-geolocation122',
  templateUrl: './geolocation122.page.html',
  styleUrls: ['./geolocation122.page.scss'],
})
export class Geolocation122Page implements OnInit {

  constructor(private router: Router) { }

  contentMap: any;
  position: any;
  coordinates = [28.103367, -15.413801];
