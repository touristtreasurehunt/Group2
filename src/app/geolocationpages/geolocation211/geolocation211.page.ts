...
@Component({
  selector: 'app-geolocation211',
  templateUrl: './geolocation211.page.html',
  styleUrls: ['./geolocation211.page.scss'],
})
export class Geolocation211Page implements OnInit {

  constructor(private router: Router) { }

  contentMap: any;
  position: any;
  coordinates = [28.100653, -15.415049];
