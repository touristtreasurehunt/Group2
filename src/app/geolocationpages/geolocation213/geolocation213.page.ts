...
@Component({
  selector: 'app-geolocation213',
  templateUrl: './geolocation213.page.html',
  styleUrls: ['./geolocation213.page.scss'],
})
export class Geolocation213Page implements OnInit {

  constructor(private router: Router) { }

  contentMap: any;
  position: any;
  coordinates = [28.101101, -15.414228];
