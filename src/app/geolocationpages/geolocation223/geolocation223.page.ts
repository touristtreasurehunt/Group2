...
@Component({
  selector: 'app-geolocation223',
  templateUrl: './geolocation223.page.html',
  styleUrls: ['./geolocation223.page.scss'],
})
export class Geolocation223Page implements OnInit {

  constructor(private router: Router) { }

  contentMap: any;
  position: any;
  coordinates = [28.099915, -15.415239];
