...
@Component({
  selector: 'app-geolocation113',
  templateUrl: './geolocation113.page.html',
  styleUrls: ['./geolocation113.page.scss'],
})
export class Geolocation113Page implements OnInit {

  constructor(private router: Router) { }

  contentMap: any;
  position: any;
  coordinates = [28.104621, -15.415633];
